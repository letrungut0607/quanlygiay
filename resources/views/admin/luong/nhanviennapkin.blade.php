...
@section('title', 'Danh sách lương nhân viên napkin')
@section('content')
<div id="content">
<div id="content-header">
  <div id="breadcrumb"> <a href="{{ route('admin.dashboard') }}" title="Trang chủ" class="tip-bottom"><i class="icon-home"></i> Trang chủ</a> <a href="{{ route('luong.nhanviennapkin') }}" class="tip-bottom">lương nhân viên napkin</a></div>
  <h1>Danh sách lương nhân viên napkin đang có {{ !empty($data['dieukien_loc']) ? $data['dieukien_loc'] : 'trong tháng này' }}</h1>
</div>
    ...
    <div class="span12">
      <div class="widget-box">
        <div class="widget-content" style="padding: 0px">
          <form class="form-horizontal" action="{{ route('luong.nhanviennapkin') }}" method="get">
            @php
            ...
            <div class="control-group">
              ...
              <div class="controls controls-row">
                ...
                @if (request()->all())
                <a href="{{ route('luong.nhanviennapkin') }}" class="btn btn-danger span1">Hủy</a>
                @endif
              </div>
            </div>
          </form>
  ...
  <div class="row-fluid">
    <div class="widget-box">
      <div class="widget-title"> 
        ...
        <h5>Tất cả lương nhân viên napkin {{ !empty($data['dieukien_loc']) ? $data['dieukien_loc'] : 'trong tháng này' }}</h5>
        <span class="mytool">
